...
import br.com.iatapp.commons.Vivo2HuaweiCommons;
...
public class AtivacaoVivo2HuaweiFunctions {
	...
	public AtivacaoVivo2HuaweiFunctions(RedeIpFunctions redeIpFunctions) {
	 ...
	 * @param vivo2IdDomain
	 */
	public AtivacaoVivo2HuaweiFunctions(RedeIpFunctions redeIpFunctions, Vivo2IdDomain vivo2IdDomain, List<Vivo2ScriptDomain> lstScripts) {
		...
		try {
			...
			ExceptionLogger.record(ExceptionUtils.getStackTrace(e),
					RedeHelper.retornaInfoProcedimento(AtivacaoVivo2HuaweiFunctions.class.getName(), vivo2IdDomain.getIdTbs(), "AtivacaoVivo2CiscoFunctions"));
		}
	}
	...
	public void iniciaProcedimento() {
		...
		Vivo2HuaweiCommons vivo2HuaweiCommons = new Vivo2HuaweiCommons(redeIpFunctions, vivo2IdDomain);
		RetornoModel retornoModel;
		
		// CHECK_VALIDACAO_IPS_LIVRES
		
		retornoModel = vivo2HuaweiCommons.checkIpsLivres();
		...
		// Limpa Log
		redeIpFunctions.limpaLog(RedeHelper.retornaInfoProcedimento(AtivacaoVivo2HuaweiFunctions.class.getName(), 
		...
		retornoModel = vivo2HuaweiCommons.checkInterfaceConfiguracao();
		gravaLogResultado.record(vivo2IdDomain.getTipoTeste().getCodigo(), 
		...
		if(retornoModel.isResultado()) {			
			retornoModel = vivo2HuaweiCommons.iniciaProcedimentoConfiguracao(lstScripts);
			gravaLogResultado.record(vivo2IdDomain.getTipoTeste().getCodigo(), 
		...
		retornoModel = vivo2HuaweiCommons.checkConfiguracaoIps();
		gravaLogResultado.record(vivo2IdDomain.getTipoTeste().getCodigo(), 
